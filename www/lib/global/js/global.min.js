...
function(e,g){var h=arguments.length&&(d||"boolean"!=typeof e),k=d||(!0===e||!0===g?"margin":"border");return c.access(this,function(b,d,e){var f;return c.isWindow(b)?b.document.documentElement["client"+a]:9===b.nodeType?(f=b.documentElement,Math.max(b.body["scroll"+a],f["scroll"+a],b.body["offset"+a],f["offset"+a],f["client"+a])):e===p?c.css(b,d,e,k):c.style(b,d,e,k)},b,h?e:p,h,null)}})});r.jQuery=r.$=c;"function"==typeof define&&define.amd&&define.amd.jQuery&&define("jquery",[],function(){return c})})(window);(function(e,m){var h=e.History=e.History||{},g=e.jQuery;if("undefined"!=typeof h.Adapter)throw Error("History.js Adapter has already been loaded...");h.Adapter={bind:function(e,h,n){g(e).bind(h,n)},trigger:function(e,h,n){g(e).trigger(h,n)},extractEventData:function(e,g,h){return g&&g.originalEvent&&g.originalEvent[e]||h&&h[e]||m},onDomLoad:function(e){g(e)}};"undefined"!=typeof h.init&&h.init()})(window);
(function(e,m){var h=e.console||m,g=e.document,l=e.navigator,p=e.sessionStorage||!1,n=e.setTimeout,s=e.clearTimeout,t=e.setInterval,v=e.clearInterval,k=e.JSON,w=e.alert,a=e.History=e.History||{},r=e.history;k.stringify=k.stringify||k.encode;k.parse=k.parse||k.decode;if("undefined"!=typeof a.init)throw Error("History.js Core has already been loaded...");a.init=function(){return"undefined"==typeof a.Adapter?!1:("undefined"!=typeof a.initCore&&a.initCore(),"undefined"!=typeof a.initHtml4&&a.initHtml4(),
...
g.title;a.intervalList=[];a.clearAllIntervals=function(){var b,c=a.intervalList;if("undefined"!=typeof c&&null!==c){for(b=0;b<c.length;b++)v(c[b]);a.intervalList=null}};a.debug=function(){a.options.debug&&a.log.apply(a,arguments)};a.log=function(){var a="undefined"!=typeof h&&"undefined"!=typeof h.log&&"undefined"!=typeof h.log.apply,c=g.getElementById("log"),d,f,e,q;a?(f=Array.prototype.slice.call(arguments),d=f.shift(),"undefined"!=typeof h.debug?h.debug.apply(h,[d,f]):h.log.apply(h,[d,f])):d="\n"+
arguments[0]+"\n";f=1;for(e=arguments.length;f<e;++f){q=arguments[f];if("object"==typeof q&&"undefined"!=typeof k)try{q=k.stringify(q)}catch(l){}d+="\n"+q+"\n"}return c?(c.value+=d+"\n-----\n",c.scrollTop=c.scrollHeight-c.clientHeight):a||w(d),!0};a.getInternetExplorerMajorVersion=function(){var b=a.getInternetExplorerMajorVersion,c;if("undefined"!=typeof a.getInternetExplorerMajorVersion.cached)c=a.getInternetExplorerMajorVersion.cached;else{c=3;for(var d=g.createElement("div"),f=d.getElementsByTagName("i");(d.innerHTML=
"\x3c!--[if gt IE "+ ++c+"]><i></i><![endif]--\x3e")&&f[0];);c=4<c?c:!1}return b.cached=c};a.isInternetExplorer=function(){return a.isInternetExplorer.cached="undefined"!=typeof a.isInternetExplorer.cached?a.isInternetExplorer.cached:Boolean(a.getInternetExplorerMajorVersion())};a.emulated={pushState:!Boolean(e.history&&e.history.pushState&&e.history.replaceState&&!/ Mobile\/([1-7][a-z]|(8([abcde]|f(1[0-8]))))/i.test(l.userAgent)&&!/AppleWebKit\/5([0-2]|3[0-2])/i.test(l.userAgent)),hashChange:Boolean(!("onhashchange"in
e||"onhashchange"in g)||a.isInternetExplorer()&&8>a.getInternetExplorerMajorVersion())};a.enabled=!a.emulated.pushState;a.bugs={setHash:Boolean(!a.emulated.pushState&&"Apple Computer, Inc."===l.vendor&&/AppleWebKit\/5([0-2]|3[0-3])/.test(l.userAgent)),safariPoll:Boolean(!a.emulated.pushState&&"Apple Computer, Inc."===l.vendor&&/AppleWebKit\/5([0-2]|3[0-3])/.test(l.userAgent)),ieDoubleCheck:Boolean(a.isInternetExplorer()&&8>a.getInternetExplorerMajorVersion()),hashEscape:Boolean(a.isInternetExplorer()&&
7>a.getInternetExplorerMajorVersion())};a.isEmptyObject=function(a){for(var c in a)return!1;return!0};a.cloneObject=function(a){var c,d;return a?(c=k.stringify(a),d=k.parse(c)):d={},d};a.getRootUrl=function(){var a=g.location.protocol+"//"+(g.location.hostname||g.location.host);g.location.port&&(a+=":"+g.location.port);return a+="/",a};a.getBaseHref=function(){var a=g.getElementsByTagName("base"),c=null,d="";return 1===a.length&&(c=a[0],d=c.href.replace(/[^\/]+$/,"")),d=d.replace(/\/+$/,""),d&&(d+=
"/"),d};a.getBaseUrl=function(){return a.getBaseHref()||a.getBasePageUrl()||a.getRootUrl()};a.getPageUrl=function(){var b;return b=((a.getState(!1,!1)||{}).url||g.location.href).replace(/\/+$/,"").replace(/[^\/]+$/,function(a,b,f){return/\./.test(a)?a:a+"/"}),b};a.getBasePageUrl=function(){return g.location.href.replace(/[#\?].*/,"").replace(/[^\/]+$/,function(a,c,d){return/[^\/]$/.test(a)?"":a}).replace(/\/+$/,"")+"/"};a.getFullUrl=function(b,c){var d=b,f=b.substring(0,1);return c="undefined"==typeof c?
!0:c,/[a-z]+\:\/\//.test(b)||("/"===f?d=a.getRootUrl()+b.replace(/^\/+/,""):"#"===f?d=a.getPageUrl().replace(/#.*/,"")+b:"?"===f?d=a.getPageUrl().replace(/[\?#].*/,"")+b:c?d=a.getBaseUrl()+b.replace(/^(\.\/)+/,""):d=a.getBasePageUrl()+b.replace(/^(\.\/)+/,"")),d.replace(/\#$/,"")};a.getShortUrl=function(b){var c=a.getBaseUrl(),d=a.getRootUrl();return a.emulated.pushState&&(b=b.replace(c,"")),b=b.replace(d,"/"),a.isTraditionalAnchor(b)&&(b="./"+b),b=b.replace(/^(\.\/)+/g,"./").replace(/\#$/,""),b};
a.store={};a.idToState=a.idToState||{};a.stateToId=a.stateToId||{};a.urlToId=a.urlToId||{};a.storedStates=a.storedStates||[];a.savedStates=a.savedStates||[];a.normalizeStore=function(){a.store.idToState=a.store.idToState||{};a.store.urlToId=a.store.urlToId||{};a.store.stateToId=a.store.stateToId||{}};a.getState=function(b,c){"undefined"==typeof b&&(b=!0);"undefined"==typeof c&&(c=!0);var d=a.getLastSavedState();return!d&&c&&(d=a.createStateObject()),b&&(d=a.cloneObject(d),d.url=d.cleanUrl||d.url),
d};a.getIdByState=function(b){var c=a.extractId(b.url),d;if(!c)if(d=a.getStateString(b),"undefined"!=typeof a.stateToId[d])c=a.stateToId[d];else if("undefined"!=typeof a.store.stateToId[d])c=a.store.stateToId[d];else{for(;c=(new Date).getTime()+String(Math.random()).replace(/\D/g,""),"undefined"!=typeof a.idToState[c]||"undefined"!=typeof a.store.idToState[c];);a.stateToId[d]=c;a.idToState[c]=b}return c};a.normalizeState=function(b){var c;b&&"object"==typeof b||(b={});if("undefined"!=typeof b.normalized)return b;
b.data&&"object"==typeof b.data||(b.data={});c={normalized:!0};c.title=b.title||"";c.url=a.getFullUrl(a.unescapeString(b.url||g.location.href));c.hash=a.getShortUrl(c.url);c.data=a.cloneObject(b.data);c.id=a.getIdByState(c);c.cleanUrl=c.url.replace(/\??\&_suid.*/,"");c.url=c.cleanUrl;b=!a.isEmptyObject(c.data);if(c.title||b)c.hash=a.getShortUrl(c.url).replace(/\??\&_suid.*/,""),/\?/.test(c.hash)||(c.hash+="?"),c.hash+="&_suid="+c.id;return c.hashedUrl=a.getFullUrl(c.hash),(a.emulated.pushState||a.bugs.safariPoll)&&
a.hasUrlDuplicate(c)&&(c.url=c.hashedUrl),c};a.createStateObject=function(b,c,d){b={data:b,title:c,url:d};return b=a.normalizeState(b),b};a.getStateById=function(b){b=String(b);return a.idToState[b]||a.store.idToState[b]||m};a.getStateString=function(b){var c,d,f;return c=a.normalizeState(b),d={data:c.data,title:b.title,url:b.url},f=k.stringify(d),f};a.getStateId=function(b){var c,d;return c=a.normalizeState(b),d=c.id,d};a.getHashByState=function(b){var c,d;return c=a.normalizeState(b),d=c.hash,d};
a.extractId=function(a){var c,d;return d=/(.*)\&_suid=([0-9]+)$/.exec(a),c=d?String(d[2]||""):"",c||!1};a.isTraditionalAnchor=function(a){return!/[\/\?\.]/.test(a)};a.extractState=function(b,c){var d=null,f,e;return c=c||!1,f=a.extractId(b),f&&(d=a.getStateById(f)),d||(e=a.getFullUrl(b),f=a.getIdByUrl(e)||!1,f&&(d=a.getStateById(f)),!d&&c&&!a.isTraditionalAnchor(b)&&(d=a.createStateObject(null,null,e))),d};a.getIdByUrl=function(b){return a.urlToId[b]||a.store.urlToId[b]||m};a.getLastSavedState=function(){return a.savedStates[a.savedStates.length-
1]||m};a.getLastStoredState=function(){return a.storedStates[a.storedStates.length-1]||m};a.hasUrlDuplicate=function(b){var c=!1,d;return d=a.extractState(b.url),c=d&&d.id!==b.id,c};a.storeState=function(b){return a.urlToId[b.url]=b.id,a.storedStates.push(a.cloneObject(b)),b};a.isLastSavedState=function(b){var c=!1,d,f,e;return a.savedStates.length&&(d=b.id,f=a.getLastSavedState(),e=f.id,c=d===e),c};a.saveState=function(b){return a.isLastSavedState(b)?!1:(a.savedStates.push(a.cloneObject(b)),!0)};
a.getStateByIndex=function(b){var c=null;return"undefined"==typeof b?c=a.savedStates[a.savedStates.length-1]:0>b?c=a.savedStates[a.savedStates.length+b]:c=a.savedStates[b],c};a.getHash=function(){return a.unescapeHash(g.location.hash)};a.unescapeString=function(a){for(var c;;){c=e.unescape(a);if(c===a)break;a=c}return a};a.unescapeHash=function(b){b=a.normalizeHash(b);return b=a.unescapeString(b),b};a.normalizeHash=function(a){return a.replace(/[^#]*#/,"").replace(/#.*/,"")};a.setHash=function(b,
c){var d,f,e;return!1!==c&&a.busy()?(a.pushQueue({scope:a,callback:a.setHash,args:arguments,queue:c}),!1):(d=a.escapeHash(b),a.busy(!0),f=a.extractState(b,!0),f&&!a.emulated.pushState?a.pushState(f.data,f.title,f.url,!1):g.location.hash!==d&&(a.bugs.setHash?(e=a.getPageUrl(),a.pushState(null,null,e+"#"+d,!1)):g.location.hash=d),a)};a.escapeHash=function(b){b=a.normalizeHash(b);return b=e.escape(b),a.bugs.hashEscape||(b=b.replace(/\%21/g,"!").replace(/\%26/g,"&").replace(/\%3D/g,"=").replace(/\%3F/g,
"?")),b};a.getHashByUrl=function(b){b=String(b).replace(/([^#]*)#?([^#]*)#?(.*)/,"$2");return b=a.unescapeHash(b),b};a.setTitle=function(b){var c=b.title,d;c||(d=a.getStateByIndex(0),d&&d.url===b.url&&(c=d.title||a.options.initialTitle));try{g.getElementsByTagName("title")[0].innerHTML=c.replace("<","&lt;").replace(">","&gt;").replace(" & "," &amp; ")}catch(e){}return g.title=c,a};a.queues=[];a.busy=function(b){"undefined"!=typeof b?a.busy.flag=b:"undefined"==typeof a.busy.flag&&(a.busy.flag=!1);
if(!a.busy.flag){s(a.busy.timeout);var c=function(){var b,e;if(!a.busy.flag)for(b=a.queues.length-1;0<=b;--b)e=a.queues[b],0!==e.length&&(e=e.shift(),a.fireQueueItem(e),a.busy.timeout=n(c,a.options.busyDelay))};a.busy.timeout=n(c,a.options.busyDelay)}return a.busy.flag};a.busy.flag=!1;a.fireQueueItem=function(b){return b.callback.apply(b.scope||a,b.args||[])};a.pushQueue=function(b){return a.queues[b.queue||0]=a.queues[b.queue||0]||[],a.queues[b.queue||0].push(b),a};a.queue=function(b,c){return"function"==
typeof b&&(b={callback:b}),"undefined"!=typeof c&&(b.queue=c),a.busy()?a.pushQueue(b):a.fireQueueItem(b),a};a.clearQueue=function(){return a.busy.flag=!1,a.queues=[],a};a.stateChanged=!1;a.doubleChecker=!1;a.doubleCheckComplete=function(){return a.stateChanged=!0,a.doubleCheckClear(),a};a.doubleCheckClear=function(){return a.doubleChecker&&(s(a.doubleChecker),a.doubleChecker=!1),a};a.doubleCheck=function(b){return a.stateChanged=!1,a.doubleCheckClear(),a.bugs.ieDoubleCheck&&(a.doubleChecker=n(function(){return a.doubleCheckClear(),
a.stateChanged||b(),!0},a.options.doubleCheckInterval)),a};a.safariStatePoll=function(){var b=a.extractState(g.location.href);if(!a.isLastSavedState(b))return b||a.createStateObject(),a.Adapter.trigger(e,"popstate"),a};a.back=function(b){return!1!==b&&a.busy()?(a.pushQueue({scope:a,callback:a.back,args:arguments,queue:b}),!1):(a.busy(!0),a.doubleCheck(function(){a.back(!1)}),r.go(-1),!0)};a.forward=function(b){return!1!==b&&a.busy()?(a.pushQueue({scope:a,callback:a.forward,args:arguments,queue:b}),
!1):(a.busy(!0),a.doubleCheck(function(){a.forward(!1)}),r.go(1),!0)};a.go=function(b,c){var d;if(0<b)for(d=1;d<=b;++d)a.forward(c);else{if(!(0>b))throw Error("History.go: History.go requires a positive or negative integer passed.");for(d=-1;d>=b;--d)a.back(c)}return a};if(a.emulated.pushState){var u=function(){};a.pushState=a.pushState||u;a.replaceState=a.replaceState||u}else a.onPopState=function(b,c){var d=!1,f=!1,h,k;return a.doubleCheckComplete(),h=a.getHash(),h?(k=a.extractState(h||g.location.href,
...
"popstate",a.onPopState),a.pushState=function(b,c,d,f){if(a.getHashByUrl(d)&&a.emulated.pushState)throw Error("History.js does not support states with fragement-identifiers (hashes/anchors).");if(!1!==f&&a.busy())return a.pushQueue({scope:a,callback:a.pushState,args:arguments,queue:f}),!1;a.busy(!0);var g=a.createStateObject(b,c,d);return a.isLastSavedState(g)?a.busy(!1):(a.storeState(g),a.expectedStateId=g.id,r.pushState(g.id,g.title,g.url),a.Adapter.trigger(e,"popstate")),!0},a.replaceState=function(b,
c,d,f){if(a.getHashByUrl(d)&&a.emulated.pushState)throw Error("History.js does not support states with fragement-identifiers (hashes/anchors).");if(!1!==f&&a.busy())return a.pushQueue({scope:a,callback:a.replaceState,args:arguments,queue:f}),!1;a.busy(!0);var g=a.createStateObject(b,c,d);return a.isLastSavedState(g)?a.busy(!1):(a.storeState(g),a.expectedStateId=g.id,r.replaceState(g.id,g.title,g.url),a.Adapter.trigger(e,"popstate")),!0};if(p)try{a.store=k.parse(p.getItem("History.store"))||{}}catch(x){a.store=
{}}else a.store={};a.normalizeStore();a.Adapter.bind(e,"beforeunload",a.clearAllIntervals);a.Adapter.bind(e,"unload",a.clearAllIntervals);a.saveState(a.storeState(a.extractState(g.location.href,!0)));p&&(a.onUnload=function(){var b,c;try{b=k.parse(p.getItem("History.store"))||{}}catch(d){b={}}b.idToState=b.idToState||{};b.urlToId=b.urlToId||{};b.stateToId=b.stateToId||{};for(c in a.idToState)a.idToState.hasOwnProperty(c)&&(b.idToState[c]=a.idToState[c]);for(c in a.urlToId)a.urlToId.hasOwnProperty(c)&&
(b.urlToId[c]=a.urlToId[c]);for(c in a.stateToId)a.stateToId.hasOwnProperty(c)&&(b.stateToId[c]=a.stateToId[c]);a.store=b;a.normalizeStore();p.setItem("History.store",k.stringify(b))},a.intervalList.push(t(a.onUnload,a.options.storeInterval)),a.Adapter.bind(e,"beforeunload",a.onUnload),a.Adapter.bind(e,"unload",a.onUnload));a.emulated.pushState||(a.bugs.safariPoll&&a.intervalList.push(t(a.safariStatePoll,a.options.safariPollInterval)),"Apple Computer, Inc."!==l.vendor&&"Mozilla"!==(l.appCodeName||
""))||(a.Adapter.bind(e,"hashchange",function(){a.Adapter.trigger(e,"popstate")}),a.getHash()&&a.Adapter.onDomLoad(function(){a.Adapter.trigger(e,"hashchange")}))};a.init()})(window);(function(b,q){var e=b.History,c=b.jQuery,f=b.document;if(!e.enabled)return!1;c(function(){var l=c("#content,article:first,.article:first,.post:first").filter(":first"),r=l.get(0),s=c("#menu,#nav,nav:first,.nav:first").filter(":first"),p=c(b),g=c(f.body),k=e.getRootUrl(),t={duration:800,easing:"swing"};0===l.length&&(l=g);c.expr[":"].internal=function(a,b,d,f){a=c(a).attr("href")||"";return a.substring(0,k.length)===k||-1===a.indexOf(":")};c.fn.ajaxify=function(){var a=c(this);a.find("a:internal:not(.no-ajaxy)").click(function(a){var d=
c(this),b=d.attr("href"),d=d.attr("title")||null;if(2==a.which||a.metaKey)return!0;e.pushState(null,d,b);a.preventDefault();return!1});return a};g.ajaxify();p.bind("statechange",function(){var a=e.getState().url,n=a.replace(k,"");g.addClass("loading");l.animate({opacity:0},800);c.ajax({url:a,success:function(d,e,m){d=c(String(d).replace(/<\!DOCTYPE[^>]*>/i,"").replace(/<(body)[\s]class="([^"]*)"([\s\>])/gi,'<div class="document-$1 $2"$3').replace(/<(html|head|body|title|meta|script)([\s\>])/gi,'<div class="document-$1"$2').replace(/<\/(html|head|body|title|meta|script)\>/gi,
"</div>"));e=d.find(".document-body:first");var h=e.find("#content,article:first,.article:first,.post:first").filter(":first"),k;m=h.find(".document-script");m.length&&m.detach();k=h.html()||d.html();if(!k)return f.location.href=a,!1;h=s.find("> li,> ul > li");h.filter(".active,.selected,.current,.youarehere").removeClass("active selected current youarehere");h=h.has('a[href^="'+n+'"],a[href^="/'+n+'"],a[href^="'+a+'"]');1===h.length&&h.addClass("active selected current youarehere");l.stop(!0,!0);
l.html(k).ajaxify().css("opacity",1).show();f.title=d.find(".document-title:first").text();try{f.getElementsByTagName("title")[0].innerHTML=f.title.replace("<","&lt;").replace(">","&gt;").replace(" & "," &amp; ")}catch(q){}m.each(function(){var a=c(this).text(),b=f.createElement("script");b.appendChild(f.createTextNode(a));r.appendChild(b)});g.ScrollTo?g.ScrollTo(t):b.scrollTo(0,1);g.attr("class",e.attr("class"));g.removeClass("document-body");g.removeClass("loading");p.trigger("statechangecomplete");
"undefined"!==typeof b._gaq&&b._gaq.push(["_trackPageview",n]);"undefined"!==typeof b.reinvigorate&&"undefined"!==typeof b.reinvigorate.ajax_track&&reinvigorate.ajax_track(a)},error:function(b,c,e){f.location.href=a;return!1}})})})})(window);function getHexColorFromString(a){var b;if("transparent"==a)b="000000";else if("rgb"==a.substr(0,3)){var c=a.match(/[0-9]+/g);a=parseInt(c[0],10).toString(16);b=parseInt(c[1],10).toString(16);c=parseInt(c[2],10).toString(16);2>a.length&&(a="0"+a);2>b.length&&(b="0"+b);2>c.length&&(c="0"+c);b=a+b+c}else"#"==a.charAt(0)&&(b=a.substring(1));return"0x"+b}
jQuery.extend(jQuery.browser,{flash:function(a){var b="0,0,0";try{b=(new ActiveXObject("ShockwaveFlash.ShockwaveFlash")).GetVariable("$version").replace(/\D+/g,",").match(/^,?(.+),?$/)[1]}catch(c){try{navigator.mimeTypes["application/x-shockwave-flash"].enabledPlugin&&(b=(navigator.plugins["Shockwave Flash 2.0"]||navigator.plugins["Shockwave Flash"]).description.replace(/\D+/g,",").match(/^,?(.+),?$/)[1])}catch(e){return!1}}b=b.match(/\d+/g);a=a.match(/\d+/g);for(var d=0;3>d;d++){b[d]=parseInt(b[d]||
0,10);a[d]=parseInt(a[d]||0,10);if(b[d]<a[d])return!1;if(b[d]>a[d])break}return!0}});jQuery.browser.iphone=function(){return/iphone/.test(navigator.userAgent.toLowerCase())}();
jQuery.extend(jQuery.browser,{has3d:function(){var a=document.createElement("p"),b,c={webkitTransform:"-webkit-transform",OTransform:"-o-transform",msTransform:"-ms-transform",MozTransform:"-moz-transform",transform:"transform"};document.body.insertBefore(a,null);for(var e in c)void 0!==a.style[e]&&(a.style[e]="translate3d(1px,1px,1px)",b=window.getComputedStyle(a).getPropertyValue(c[e]));document.body.removeChild(a);return void 0!==b&&0<b.length&&"none"!==b}});
jQuery.fn.flash=function(a){var b="",c="",e=[],d;for(d in a.params)e.push(d+"="+encodeURI(a.params[d]));b=b+'<object type="application/x-shockwave-flash" '+('data="'+a.src+"?"+e.join("&amp;")+'" ');void 0!==a.width&&(b+='width="'+a.width+'" ');void 0!==a.height&&(b+='height="'+a.height+'" ');void 0!==a.className&&(b+='class="'+a.className+'" ');void 0!==a.id&&(b+='id="'+a.id+'" ');c+='<param name="movie" value="'+a.src+"?"+e.join("&amp;")+'" />';!0===a.transparent&&(b+='mwmode="transparent"',c+='<param name="wmode" value="transparent" />');
b+=">";return $(b+c+"</object>")};$.fn.pause=function(a,b){a=a||1E3;return this.queue(b||"fx",function(){var b=this;setTimeout(function(){$.dequeue(b)},a)})};$.fn.clearQueue=$.fn.unpause=function(a){return this.each(function(){a=a||"fx";this.queue&&this.queue[a]&&(this.queue[a].length=0)})};
jQuery.fx.prototype.custom=function(a,b,c){function e(){return d.step()}this.startTime=(new Date).getTime();this.start=a;this.end=b;this.unit=c||this.unit||"px";this.now=this.start;this.pos=this.state=0;this.update();var d=this;e.elem=this.elem;jQuery.timers.push(e);if(1==jQuery.timers.length)var f=setInterval(function(){for(var a=jQuery.timers,b=0;b<a.length;b++)a[b]()||a.splice(b--,1);a.length||clearInterval(f)},75)};
function replaceFlashContent(){$("img.flash_repl").each(function(){var a=$(this).parent().prepend($().flash({src:this.src.replace(/\.jpg|\.gif|\.png/,".swf").replace(/\&/,"&amp;"),width:this.width,height:this.height,className:"flash",id:this.id?this.id+"_flash":null,transparent:$(this).hasClass("trans")}));"A"==a[0].nodeName&&a.click(function(){return!1})})}
function replaceInteractiveContent(){var a=0,b=$("html").attr("lang");$(".teaser").click(function(){document.location=$("a",this)[0].href});$("a[href*='mailto:']").depageAntispam();$(".social").depageSocialButtons({services:["twitter","facebookShare","googleplusShare","mail"]});$("form").each(function(){var b=this;b.id||(b.id="textbutton"+a++ +"form");$("input.textbutton",b).each(function(){$(this).hide();ionclick="submit"==this.type?"document.forms."+b.id+".submit(); return false;":"reset"==this.type?
"document.forms."+b.id+".reset(); return false;":this.onclick;$(this).after('<a href="#" onclick="'+ionclick+'">'+this.value+"</a>")})});$(".slideshow").depageSlideshow({elements:"div"});$(".compare").depageCompareImages();var c,e;"de"==b?(c="Quelltext als reinen Text anzeigen",e="Quelltext formatiert anzeigen"):(c="View this source in Plain Text",e="View this source as Highlighted Code");$(".source pre").each(function(){$(this).before('<a href="#" class="codeswitch">'+c+"</a>").after('<div><textarea rows="'+
($(this).children().html().split("\n").length-1)+'" cols="50">'+$(this).children().html()+"</textarea></div>")});$(".codeswitch").toggle(function(){$(this).text(e).next().hide().next().show()},function(){$(this).text(c).next().show().next().hide()});prettyPrint();if(!$.browser.iphone){var d,f,g,h;$(".zoom").each(function(){var a='Zum "Zoomen" mit der Maus \u00fcber das Bild fahren.';1==$(".back img",this).length&&(a+=" Klicken, um zwischen Vorder- und R\u00fcckseite zu wechseln.");$(this).append('<p class="info">('+
a+")</p>");$(this).append('<span class="thumb"><span class="border"></span><img src="'+$(".front img",this)[0].src+'"></span>')});$(".zoom").click(function(){if(1==$(".back img",this).length){var a=$(".front img",this)[0].src,b=$(".back img",this)[0].src;$(".front img",this)[0].src=b;$(".thumb img",this)[0].src=b;$(".back img",this)[0].src=a}});$(".zoom").mouseover(function(){$(this).addClass("zoomed");1==$(".back img",this).length?$(".front img",this).css("cursor","pointer"):$(".front img",this).css("cursor",
"crosshair");$(".front",this).height($(".front img",this).height());g=$(".front img",this).width();$(".front img",this).css({width:"auto",maxWidth:"none"});h=$(".front img",this).width();$(".thumb",this).stop().fadeIn(200);d=h/g;f=($(".thumb img",this).width()-$(".thumb img",this).width()/d)/g;$(".thumb .border",this).css({width:$(".thumb img",this).width()/d,height:$(".thumb img",this).height()/d,background:$.browser.msie?"none":"#ffffff"})});$(".zoom").mouseout(function(){$(this).removeClass("zoomed");
$(".front img",this).css({width:g,marginLeft:0,marginTop:0});$(".thumb",this).stop().css("opacity",1).fadeOut(200)});$(".zoom").mousemove(function(a){var b=$(this).offset().left-a.pageX,c=$(this).offset().top-a.pageY;$(".front img",this).css({marginLeft:b*(d-1),marginTop:c*(d-1)});$(".thumb .border",this).each(function(){$(this).css({left:-(b*f),top:-(c*f)})})})}}
function onDocumentScroll(){var a=window.pageYOffset||$(window).scrollTop(),b=$(window).height();$(".articlefooter").each(function(){var c=$(this);c.toggleClass("in-view",c.offset().top-2*(b/3)<a)})}
$(document).ready(function(){replaceInteractiveContent();$(window).on("statechangecomplete",replaceInteractiveContent);$(window).on("scroll resize",onDocumentScroll);$.browser.has3d()&&$("html").addClass("css-3dtransform");$.browser.flash("8,0,0")&&(replaceFlashContent(),$("html").addClass("flash"));$.browser.iphone&&$(window).load(function(){this.scrollTo(0,1)})});