...
function(e,g){var h=arguments.length&&(d||"boolean"!=typeof e),k=d||(!0===e||!0===g?"margin":"border");return c.access(this,function(b,d,e){var f;return c.isWindow(b)?b.document.documentElement["client"+a]:9===b.nodeType?(f=b.documentElement,Math.max(b.body["scroll"+a],f["scroll"+a],b.body["offset"+a],f["offset"+a],f["client"+a])):e===p?c.css(b,d,e,k):c.style(b,d,e,k)},b,h?e:p,h,null)}})});r.jQuery=r.$=c;"function"==typeof define&&define.amd&&define.amd.jQuery&&define("jquery",[],function(){return c})})(window);(function(a){a.fn.iframeAutoHeight=function(b){b=a.extend({heightOffset:0},b);a(this).each(function(){function c(a){a.style.height=(a.contentWindow.document.body.offsetHeight+b.heightOffset)/10+"em"}if(a.browser.safari||a.browser.opera){a(this).load(function(){var a=this;setTimeout(function(){c(a)},0)});var d=a(this).attr("src");a(this).attr("src","");a(this).attr("src",d)}else a(this).load(function(){c(this)}).each(function(){(this.complete||jQuery.browser.msie)&&a(this).trigger("load")})})}})(jQuery);function getHexColorFromString(b){var a;if("transparent"==b)a="000000";else if("rgb"==b.substr(0,3)){var c=b.match(/[0-9]+/g);b=parseInt(c[0],10).toString(16);a=parseInt(c[1],10).toString(16);c=parseInt(c[2],10).toString(16);2>b.length&&(b="0"+b);2>a.length&&(a="0"+a);2>c.length&&(c="0"+c);a=b+a+c}else"#"==b.charAt(0)&&(a=b.substring(1));return"0x"+a}jQuery.browser.iphone=function(){return/iphone/.test(navigator.userAgent.toLowerCase())}();
...
jQuery.fn.flash=function(b){var a="",c="",d=[],e;for(e in b.params)d.push(e+"="+encodeURI(b.params[e]));a=a+'<object type="application/x-shockwave-flash" '+('data="'+b.src+"?"+d.join("&amp;")+'" ');void 0!==b.width&&(a+='width="'+b.width+'" ');void 0!==b.height&&(a+='height="'+b.height+'" ');void 0!==b.className&&(a+='class="'+b.className+'" ');void 0!==b.id&&(a+='id="'+b.id+'" ');c+='<param name="movie" value="'+b.src+"?"+d.join("&amp;")+'" />';!0===b.transparent&&(a+='mwmode="transparent"',c+='<param name="wmode" value="transparent" />');
a+=">";return $(a+c+"</object>")};$.fn.pause=function(b,a){b=b||1E3;return this.queue(a||"fx",function(){var a=this;setTimeout(function(){$.dequeue(a)},b)})};$.fn.clearQueue=$.fn.unpause=function(b){return this.each(function(){b=b||"fx";this.queue&&this.queue[b]&&(this.queue[b].length=0)})};
jQuery.fx.prototype.custom=function(b,a,c){function d(){return e.step()}this.startTime=(new Date).getTime();this.start=b;this.end=a;this.unit=c||this.unit||"px";this.now=this.start;this.pos=this.state=0;this.update();var e=this;d.elem=this.elem;jQuery.timers.push(d);if(1==jQuery.timers.length)var f=setInterval(function(){for(var b=jQuery.timers,a=0;a<b.length;a++)b[a]()||b.splice(a--,1);b.length||clearInterval(f)},75)};
function replaceInteractiveContent(){var b=0,a=$("html").attr("lang");$(".teaser").click(function(){document.location=$("a",this)[0].href});$("form").each(function(){var a=this;a.id||(a.id="textbutton"+b++ +"form");$("input.textbutton",a).each(function(){$(this).hide();ionclick="submit"==this.type?"document.forms."+a.id+".submit(); return false;":"reset"==this.type?"document.forms."+a.id+".reset(); return false;":this.onclick;$(this).after('<a href="#" onclick="'+ionclick+'">'+this.value+"</a>")})});
var c,d;"de"==a?(c="Quelltext als reinen Text anzeigen",d="Quelltext formatiert anzeigen"):(c="View this source in Plain Text",d="View this source as Highlighted Code");$(".source pre").each(function(){$(this).before('<a href="#" class="codeswitch">'+c+"</a>").after('<div><textarea rows="'+($(this).children().html().split("\n").length-1)+'" cols="50">'+$(this).children().html()+"</textarea></div>")});$(".codeswitch").toggle(function(){$(this).text(d).next().hide().next().show()},function(){$(this).text(c).next().show().next().hide()});
$("iframe[seamless]").iframeAutoHeight({heightOffset:30})}function addDoxygenBehaviours(){$(".dynheader").toggle(function(){$(this).addClass("active");$(".dyncontent").show()},function(){$(this).removeClass("active");$(".dyncontent").hide()});$(".dyncontent").hide()}function onDocumentScroll(){var b=window.pageYOffset||$(window).scrollTop(),a=$(window).height();$(".articlefooter").each(function(){var c=$(this);c.toggleClass("in-view",c.offset().top-2*(a/3)<b)})}
$(document).ready(function(){replaceInteractiveContent();addDoxygenBehaviours();$(window).on("statechangecomplete",replaceInteractiveContent);$(window).on("scroll resize",onDocumentScroll);$.browser.has3d()&&$("html").addClass("css-3dtransform");$.browser.iphone&&$(window).load(function(){this.scrollTo(0,1)})});var indexSectionsWithContent={0:"",1:"",
...
6:""},indexSectionNames={0:"all",1:"classes",2:"namespaces",3:"files",4:"functions",5:"variables",6:"pages"};
function convertToId(d){var a="";for(i=0;i<d.length;i++)var b=d.charAt(i),c=b.charCodeAt(0),a=b.match(/[a-z0-9]/)?a+b:16>c?a+("_0"+c.toString(16)):a+("_"+c.toString(16));return a}function getXPos(d){var a=0;if(d.offsetWidth)for(;d&&d!=document.body;)a+=d.offsetLeft,d=d.offsetParent;return a}function getYPos(d){var a=0;if(d.offsetWidth)for(;d&&d!=document.body;)a+=d.offsetTop,d=d.offsetParent;return a}
function SearchBox(d,a,b,c){d&&a||alert("Missing parameters to SearchBox.");this.name=d;this.resultsPath=a;this.keyTimeout=0;this.keyTimeoutLength=500;this.closeSelectionTimeout=300;this.lastResultsPage=this.lastSearchValue="";this.searchIndex=this.hideTimeout=0;this.searchActive=!1;this.insideFrame=b;this.searchLabel=c;this.DOMSearchField=function(){return document.getElementById("MSearchField")};this.DOMSearchSelect=function(){return document.getElementById("MSearchSelect")};this.DOMSearchSelectWindow=
function(){return document.getElementById("MSearchSelectWindow")};this.DOMPopupSearchResults=function(){return document.getElementById("MSearchResults")};this.DOMPopupSearchResultsWindow=function(){return document.getElementById("MSearchResultsWindow")};this.DOMSearchClose=function(){return document.getElementById("MSearchClose")};this.DOMSearchBox=function(){return document.getElementById("MSearchBox")};this.OnSearchFieldFocus=function(a){this.Activate(a)};this.OnSearchSelectShow=function(){var a=
this.DOMSearchSelectWindow(),e=this.DOMSearchSelect();if(this.insideFrame){var b=getXPos(e),c=getYPos(e),b=b+(e.offsetWidth+6),c=c+e.offsetHeight;a.style.display="block";b-=a.offsetWidth}else b=getXPos(e),c=getYPos(e),c+=e.offsetHeight,a.style.display="block";a.style.left=b+"px";a.style.top=c+"px";this.hideTimeout&&(clearTimeout(this.hideTimeout),this.hideTimeout=0);return!1};this.OnSearchSelectHide=function(){this.hideTimeout=setTimeout(this.name+".CloseSelectionWindow()",this.closeSelectionTimeout)};
this.OnSearchFieldChange=function(a){this.keyTimeout&&(clearTimeout(this.keyTimeout),this.keyTimeout=0);a=a?a:window.event;if(40==a.keyCode||13==a.keyCode){if(1==a.shiftKey){this.OnSearchSelectShow();a=this.DOMSearchSelectWindow();for(i=0;i<a.childNodes.length;i++){var b=a.childNodes[i];if("SelectItem"==b.className){b.focus();break}}return}window.frames.MSearchResults.searchResults&&(a=window.frames.MSearchResults.searchResults.NavNext(0))&&a.focus()}else if(27==a.keyCode){this.DOMSearchField().blur();
this.DOMPopupSearchResultsWindow().style.display="none";this.DOMSearchClose().style.display="none";this.lastSearchValue="";this.Activate(!1);return}a=this.DOMSearchField().value.replace(/ +/g,"");a!=this.lastSearchValue&&(""!=a?this.keyTimeout=setTimeout(this.name+".Search()",this.keyTimeoutLength):(this.DOMPopupSearchResultsWindow().style.display="none",this.DOMSearchClose().style.display="none",this.lastSearchValue=""))};this.SelectItemCount=function(a){a=0;var b=this.DOMSearchSelectWindow();for(i=
0;i<b.childNodes.length;i++)"SelectItem"==b.childNodes[i].className&&a++;return a};this.SelectItemSet=function(a){var b,c=0,d=this.DOMSearchSelectWindow();for(b=0;b<d.childNodes.length;b++){var g=d.childNodes[b];"SelectItem"==g.className&&(g.firstChild.innerHTML=c==a?"&#8226;":"&#160;",c++)}};this.OnSelectItem=function(a){this.searchIndex=a;this.SelectItemSet(a);""!=this.DOMSearchField().value.replace(/ +/g,"")&&this.searchActive&&this.Search()};this.OnSearchSelectKey=function(a){a=a?a:window.event;
if(40==a.keyCode&&this.searchIndex<this.SelectItemCount())this.searchIndex++,this.OnSelectItem(this.searchIndex);else if(38==a.keyCode&&0<this.searchIndex)this.searchIndex--,this.OnSelectItem(this.searchIndex);else if(13==a.keyCode||27==a.keyCode)this.OnSelectItem(this.searchIndex),this.CloseSelectionWindow(),this.DOMSearchField().focus();return!1};this.CloseResultsWindow=function(){this.DOMPopupSearchResultsWindow().style.display="none";this.DOMSearchClose().style.display="none";this.Activate(!1)};
this.CloseSelectionWindow=function(){this.DOMSearchSelectWindow().style.display="none"};this.Search=function(){this.keyTimeout=0;var a=this.DOMSearchField().value.replace(/^ +/,""),b=a.toLowerCase().charCodeAt(0),c;c=16>b?"0"+b.toString(16):b.toString(16);"1"==indexSectionsWithContent[this.searchIndex].charAt(b)?(b=this.resultsPath+"/"+indexSectionNames[this.searchIndex]+"_"+c+".html",c=b+"?"+escape(a)):c=b=this.resultsPath+"/nomatches.html";window.frames.MSearchResults.location=c;c=this.DOMPopupSearchResultsWindow();
if("block"!=c.style.display){var d=this.DOMSearchBox();this.DOMSearchClose().style.display="inline";if(this.insideFrame){var g=this.DOMPopupSearchResults();c.style.position="relative";c.style.display="block";var h=document.body.clientWidth-8;c.style.width=h+"px";g.style.width=h+"px"}else g=this.DOMPopupSearchResults(),h=getXPos(d)+150,d=getYPos(d)+20,c.style.display="block",h-=g.offsetWidth,c.style.top=d+"px",c.style.left=h+"px"}this.lastSearchValue=a;this.lastResultsPage=b};this.Activate=function(a){a||
"block"==this.DOMPopupSearchResultsWindow().style.display?(this.DOMSearchBox().className="MSearchBoxActive",a=this.DOMSearchField(),a.value==this.searchLabel&&(a.value="",this.searchActive=!0)):a||(this.DOMSearchBox().className="MSearchBoxInactive",this.DOMSearchField().value=this.searchLabel,this.searchActive=!1,this.lastResultsPage=this.lastSearchValue="")}}
function SearchResults(d){this.lastKey=this.lastMatchCount=0;this.repeatOn=!1;this.FindChildElement=function(a){a=document.getElementById(a);for(var b=a.firstChild;b&&b!=a;){if("DIV"==b.nodeName&&"SRChildren"==b.className)return b;if("DIV"==b.nodeName&&b.hasChildNodes())b=b.firstChild;else if(b.nextSibling)b=b.nextSibling;else{do b=b.parentNode;while(b&&b!=a&&!b.nextSibling);b&&b!=a&&(b=b.nextSibling)}}};this.Toggle=function(a){if(a=this.FindChildElement(a))a.style.display="block"==a.style.display?
"none":"block"};this.Search=function(a){a||(a=window.location.search,a=a.substring(1),a=unescape(a));a=a.replace(/^ +/,"");a=a.replace(/ +$/,"");a=a.toLowerCase();a=convertToId(a);for(var b=document.getElementsByTagName("div"),c=0,d=0;d<b.length;){var e=b.item(d);if("SRResult"==e.className){var f=e.id.toLowerCase(),f=f.replace(/^sr\d*_/,"");a.length<=f.length&&f.substr(0,a.length)==a?(e.style.display="block",c++):e.style.display="none"}d++}document.getElementById("Searching").style.display="none";
0==c?document.getElementById("NoMatches").style.display="block":document.getElementById("NoMatches").style.display="none";this.lastMatchCount=c;return!0};this.NavNext=function(a){for(var b;(!(b=document.getElementById("Item"+a))||"block"!=b.parentNode.parentNode.style.display)&&b;)b=null,a++;return b};this.NavPrev=function(a){for(var b;(!(b=document.getElementById("Item"+a))||"block"!=b.parentNode.parentNode.style.display)&&b;)b=null,a--;return b};this.ProcessKeys=function(a){if("keydown"==a.type)this.repeatOn=
!1,this.lastKey=a.keyCode;else if("keypress"==a.type){if(!this.repeatOn)return this.lastKey&&(this.repeatOn=!0),!1}else"keyup"==a.type&&(this.lastKey=0,this.repeatOn=!1);return 0!=this.lastKey};this.Nav=function(a,b){var c=a?a:window.event;if(13==c.keyCode)return!0;if(!this.ProcessKeys(c))return!1;if(38==this.lastKey){var c=b-1,d=this.NavPrev(c);if(d){var e=this.FindChildElement(d.parentNode.parentNode.id);if(e&&"block"==e.style.display)for(var e=0,f;;){if(f=document.getElementById("Item"+c+"_c"+
e))d=f;else break;e++}}d?d.focus():parent.document.getElementById("MSearchField").focus()}else if(40==this.lastKey)c=b+1,e=document.getElementById("Item"+b),(e=this.FindChildElement(e.parentNode.parentNode.id))&&"block"==e.style.display&&(d=document.getElementById("Item"+b+"_c0")),d||(d=this.NavNext(c)),d&&d.focus();else if(39==this.lastKey){if(e=document.getElementById("Item"+b),e=this.FindChildElement(e.parentNode.parentNode.id))e.style.display="block"}else if(37==this.lastKey){if(e=document.getElementById("Item"+
b),e=this.FindChildElement(e.parentNode.parentNode.id))e.style.display="none"}else if(27==this.lastKey)parent.searchBox.CloseResultsWindow(),parent.document.getElementById("MSearchField").focus();else if(13==this.lastKey)return!0;return!1};this.NavChild=function(a,b,c){a=a?a:window.event;if(13==a.keyCode)return!0;if(!this.ProcessKeys(a))return!1;if(38==this.lastKey)0<c?document.getElementById("Item"+b+"_c"+(c-1)).focus():document.getElementById("Item"+b).focus();else if(40==this.lastKey)(c=document.getElementById("Item"+
b+"_c"+(c+1)))||(c=this.NavNext(b+1)),c&&c.focus();else if(27==this.lastKey)parent.searchBox.CloseResultsWindow(),parent.document.getElementById("MSearchField").focus();else if(13==this.lastKey)return!0;return!1}}function setKeyActions(d,a){d.setAttribute("onkeydown",a);d.setAttribute("onkeypress",a);d.setAttribute("onkeyup",a)}function setClassAttr(d,a){d.setAttribute("class",a);d.setAttribute("className",a)}
function createResults(){for(var d=document.getElementById("SRResults"),a=0;a<searchData.length;a++){var b=searchData[a][0],c=document.createElement("div");c.setAttribute("id","SR_"+b);setClassAttr(c,"SRResult");var k=document.createElement("div");setClassAttr(k,"SREntry");var e=document.createElement("a");e.setAttribute("id","Item"+a);setKeyActions(e,"return searchResults.Nav(event,"+a+")");setClassAttr(e,"SRSymbol");e.innerHTML=searchData[a][1][0];k.appendChild(e);if(2==searchData[a][1].length)e.setAttribute("href",
searchData[a][1][1][0]),searchData[a][1][1][1]&&e.setAttribute("target","_parent"),b=document.createElement("span"),setClassAttr(b,"SRScope"),b.innerHTML=searchData[a][1][1][2];else for(e.setAttribute("href",'javascript:searchResults.Toggle("SR_'+b+'")'),b=document.createElement("div"),setClassAttr(b,"SRChildren"),e=0;e<searchData[a][1].length-1;e++){var f=document.createElement("a");f.setAttribute("id","Item"+a+"_c"+e);setKeyActions(f,"return searchResults.NavChild(event,"+a+","+e+")");setClassAttr(f,
"SRScope");f.setAttribute("href",searchData[a][1][e+1][0]);searchData[a][1][e+1][1]&&f.setAttribute("target","_parent");f.innerHTML=searchData[a][1][e+1][2];b.appendChild(f)}k.appendChild(b);c.appendChild(k);d.appendChild(c)}};function toggleVisibility(b){var a=$(b).attr("id"),c=$("#"+a+"-summary"),d=$("#"+a+"-content"),a=$("#"+a+"-trigger"),e=$(a).attr("src");!0===d.is(":visible")?(d.hide(),c.show(),$(b).addClass("closed").removeClass("opened"),$(a).attr("src",e.substring(0,e.length-8)+"closed.png")):(d.show(),c.hide(),$(b).removeClass("closed").addClass("opened"),$(a).attr("src",e.substring(0,e.length-10)+"open.png"));return!1}
function updateStripes(){$("table.directory tr").removeClass("even").filter(":visible:even").addClass("even")}function toggleLevel(b){$("table.directory tr").each(function(){var a=this.id.split("_").length-1,c=$("#img"+this.id.substring(3)),d=$("#arr"+this.id.substring(3));a<b+1?(c.attr("src","ftv2folderopen.png"),d.attr("src","ftv2mnode.png"),$(this).show()):a==b+1?(c.attr("src","ftv2folderclosed.png"),d.attr("src","ftv2pnode.png"),$(this).show()):$(this).hide()});updateStripes()}
function toggleFolder(b){var a=$("#row_"+b),c=a.find("img"),d=a.nextAll("tr"),e=d.filter(function(){return this.id.match(RegExp("^row_"+b+"\\d+_$","i"))});!0===e.filter(":first").is(":visible")?(c.filter("[id^=arr]").attr("src","ftv2pnode.png"),c.filter("[id^=img]").attr("src","ftv2folderclosed.png"),d.filter("[id^=row_"+b+"]").hide()):(d=e.find("img"),c=d.filter("[id^=img]"),d=d.filter("[id^=arr]"),a.find("[id^=arr]").attr("src","ftv2mnode.png"),a.find("[id^=img]").attr("src","ftv2folderopen.png"),
c.attr("src","ftv2folderclosed.png"),d.attr("src","ftv2pnode.png"),e.show());updateStripes()}function toggleInherit(b){var a=$("tr.inherit."+b);b=$("tr.inherit_header."+b+" img");var c=$(b).attr("src");!0===a.filter(":first").is(":visible")?(a.css("display","none"),$(b).attr("src",c.substring(0,c.length-8)+"closed.png")):(a.css("display","table-row"),$(b).attr("src",c.substring(0,c.length-10)+"open.png"))}
$(document).ready(function(){$(".code,.codeRef").each(function(){$(this).data("powertip",$("#"+$(this).attr("href").replace(/.*\//,"").replace(/[^a-z_A-Z0-9]/g,"_")).html());$(this).powerTip({placement:"s",smartPlacement:!0,mouseOnToPopup:!0})})});